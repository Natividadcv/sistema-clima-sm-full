                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Vista de Ticket</h4>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card-body p-4">
                                            ...
                                            <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                                                <a href="javascript:window.print()" class="btn btn-success"><i class="ri-coupon-3-line align-bottom me-1"></i> Ticket</a>
                                            </div>
                                        </div>
