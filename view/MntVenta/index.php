                                        ...
                                        <div class="card-body">
                                            <div class="live-preview">
                                                <div class="row align-items-center g-3">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <label for="detv_descuento" class="form-label">Desc.</label>
                                                        <input type="number" class="form-control" id="detv_descuento" name="detv_descuento" placeholder="Descue." />
                                                    </div>
