...
$(document).on("click", "#btnagregar", function () {
  ...
  var detv_descun = $("#detv_descun").val();
  ...
  if (
    ...
    // Validar el stock
    var prod_stock = parseFloat($("#prod_stock").val());
    var requested_qty = parseFloat(detv_cant);
    if (requested_qty > prod_stock) {
      ...
      // Envíe los datos del detalle de venta al servidor si el stock es suficiente
      $.post(
