...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-04-2023 a las 03:32:55
...
(61, 'holaa', 'Manteminieto de aire', '2023-03-28', '2023-03-31', '#000000', 7, 6, 'sdsa', 'sfasdf', 'fdsa', 1, 0),
(62, 'sublimar camisa', 'Instalacion de aire', '2023-04-07', '2023-04-07', '#0aa1ff', 7, 9, 'San Miguel', 'tu casa', 'Estar antes de las 3', 1, 0);
...
(5, 1, 4, 'Lennox 4 Pro', 'Este es un aire con algunas cosas', 2, 1, '500.00', '700.00', 10, NULL, '', '2023-04-07 15:01:13.242', 1),
(6, 1, 5, 'Lennox 7 Pro Plus', 'Nada', 3, 1, '1000.00', '2500.00', 67, NULL, '', '2023-04-09 12:24:26.774', 1),
(7, 1, 4, 'Daikin Split Inverter', 'nada', 2, 1, '500.00', '1500.00', 208, NULL, '', '2023-04-09 13:14:46.989', 1),
(8, 1, 6, 'LG Inverter 0102', 'Aire minisplit de 1200 ', 1, 1, '450.00', '525.00', 6, NULL, '', '2023-04-12 19:14:17.707', 1),
...
--
ALTER TABLE `td_compra_detalle`
  MODIFY `DETC_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `td_venta_detalle`
  MODIFY `DETV_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `tm_compra`
  MODIFY `COMPR_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `tm_venta`
  MODIFY `VENT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
