...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2023 a las 09:06:27
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_estado` ()   BEGIN
    SELECT e.id, e.title, e.start, e.end, e.color, e.idcliente, e.est, c.CLI_NOM, c.CLI_CORREO
    FROM evento e
...
INSERT INTO `evento` (`id`, `title`, `start`, `end`, `color`, `idcliente`, `est`) VALUES
(47, 'Instalacion', '2023-04-01', '2023-04-02', '#ff0000', 7, 1),
(48, 'Instalación aire Hospital', '2023-04-09', '2023-04-12', '#5a51e1', 8, 1);
...
(7, 1, 'Antonia', '11111', '76532461', 'Jiquilisco, Usulután', 'antonia@gmail.com', '2023-04-09 00:53:24.336', 1),
(8, 1, 'Carlos', '21212', '76532461', 'Jiquilisco, Usulután', 'carlosmarioc772@gmail.com', '2023-04-09 00:59:00.761', 1);
